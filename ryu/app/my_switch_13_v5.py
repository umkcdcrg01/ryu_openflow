...
# V5. 
# save ovs datapath object
# control arp and icmp packet
# need to mannual start arp from host: szb53@h2:~$ arping -f -I eth1  -s 10.10.5.2 10.10.5.3 -b
# Automatically arp will be in version v6
# Automatcially install flow along the shortest path will be in version v6
...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        dpid = datapath.id
        #with open(str(dpid).join(".pickle"), 'wb') as f:
        # save all the switch's datapath object
    ...
    def _packet_in_handler(self, ev):
        ...
        if pkt_arp: 
            ...
            self._send_packet(datapath, in_port, out_port, eth, msg)
        if pkt_icmp:
            shortest_path_list = \
    ...
    def _handle_arp(self, datapath, port, pkt_ethernet, pkt_arp):
        ...
        if pkt_arp.opcode == arp.ARP_REQUEST:
            ...
            # print "arp_request: ", self.arp_request
